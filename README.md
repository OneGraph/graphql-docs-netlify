...
Add a new markdown file with a single graphql query to `src/examples`. You should provide a description of your query in the front matter.

Gatsby will automatically create a page for you example.
